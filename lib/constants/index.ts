...
export const plans = [
  {
    ...
    description: "مناسب برای خانه‌های اجاره‌ای یا بودجه محدود و زوج های جوان",
    features: [
      "بدون تخریب یا بازسازی کامل",
      "اقتصادی‌تر از نصب کابینت نو",
      "تعمیر کابینت‌های آسیب‌دیده",
      "تعویض یراق‌آلات قدیمی",
      "صفحه کابینت اقتصادی",
      "تعویض درب‌ها بدون تعویض بدنه",
    ],
    popular: true,
  },
  // {
