...
export const ALLOWED_STORAGE_FOLDERS = [
  ...
  "materials/images",
  "materials/pdfs",
  // پوشه‌ی عکس پروفایل کاربران — برخلاف پوشه‌های بالا که مخصوص ادمین
  // هستند، این یکی تنها پوشه‌ای است که هر کاربر لاگین‌شده (نه فقط ادمین)
  // اجازه‌ی آپلود در آن را دارد؛ محدودیتش در app/api/storage/upload اعمال می‌شود.
  "avatars",
];
